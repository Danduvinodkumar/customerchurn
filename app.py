...
model_filename1 = r"models/random_forest_model.pkl"
with open(model_filename1, 'rb') as file:
    model_random = pickle.load(file)

# Load the standard scaler
model_filename3 = r"models/standard_scaler.pkl"
...
def predict():
    ...
    # Perform label encoding on the categorical columns using direct mappings
